            ...
            <div className="container mx-auto px-4 md:px-6">
              <div className="max-w-2xl">
                ...
                <p className="text-lg md:text-xl text-primary-foreground/80 mb-8 max-w-xl leading-relaxed">
                  Whether you need secure storage, asset transport, or a private consultation, our Melbourne-based team is ready to help.
                </p>
          ...
          <div className="space-y-6">
            <Card className="border border-border">
              ...
              <CardContent className="space-y-1">
                <p className="text-base font-semibold text-foreground">Aurevault Precious Metals Pty LTD</p>
                <p className="text-sm text-muted-foreground">3792 Collin's Street</p>
                <p className="text-sm text-muted-foreground">Melbourne, VIC 3068</p>
            ...
            <Card className="border border-border">
              ...
              <CardContent>
                <a href="tel:+61480831062" className="text-base font-semibold text-accent hover:underline">
                  +61480831062
                </a>
              </CardContent>
            </Card>
            ...
            <CardContent>
              <form className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input id="phone" type="tel" placeholder="+61 000 000 000" required />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="asset-type">Asset Type</Label>
                  <Input id="asset-type" placeholder="Gold, Diamonds, etc." required />
                </div>
                <div className="space-y-2">
